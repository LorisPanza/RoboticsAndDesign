...
VR myVR(13, 12);//VR myVR(3,2);    // 2:RX 3:TX, you can choose your favourite pins.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void setup() {
  pinMode(gateSound, INPUT);
  attachInterrupt(0, soundISR, RISING);
...
bool transition_shoulder_big_noise(){
  ...
  int scale;
  Serial.print("LAST  RECORDED: ");Serial.println(sound);
  scale = map(sound, 0, 300, 0, 3);

  if(scale > 2){
    Serial.print("I'M SCARED -> NOISE SCALE: ");Serial.println(scale);
    set_fear();
    display_state();
    set_neutral();
    display_state();
